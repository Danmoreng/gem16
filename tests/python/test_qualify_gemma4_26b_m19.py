    ...
    def __init__(self, root: Path):
        ...
        self.thresholds = write(
            root / "thresholds.json",
            {
                "schema_version": 1,
                "milestone": "M19",
                "status": "frozen_before_heldout_execution",
                "identity": {
                    "artifact_content_sha256": self.content_hash,
                ...
                "thresholds": {
                    "teacher_forced_weighted_mean_nll_delta_max": 0.1,
                    "teacher_forced_category_mean_nll_delta_max": 0.2,
                    "teacher_forced_weighted_mean_kl_max": 0.02,
                    "teacher_forced_record_kl_max": 0.05,
                    "teacher_forced_reference_token_top5_fraction_min": 0.95,
                    "teacher_forced_top1_agreement_fraction_min": 0.8,
                    "selected_layer_relative_l2_max": 0.25,
                    "selected_layer_cosine_min": 0.98,
                    "router_top8_overlap_min": 5,
                    "attention_relative_l2_max": 0.25,
                    "attention_cosine_min": 0.98,
                ...
                "records": [
                    {
                        ...
                        "teacher_forced": {
                            ...
                            "candidate_mean_nll": 1.01,
                            "qat_bf16_mean_nll": 1.0,
                            "qat_bf16_to_candidate_mean_kl": 0.01,
                            "qat_reference_token_top5_fraction": 1.0,
            ...
            pairs.append(
                {
                    ...
                    "reference_source_lock_sha256": self.source_hash,
        ...
        self.task_manifest = write(
            root / "tasks.json",
            {
                ...
                "status": "complete",
                "artifact_content_sha256": self.content_hash,
                "qat_source_lock_sha256": self.source_hash,
                "sgl_eval_commit": "eval-commit",
                "pairs": pairs,
            },
        )
...
class QualifyGemma426BM19Test(unittest.TestCase):
    ...
    def test_category_regression_cannot_hide_in_aggregate(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            numerical["records"][0]["teacher_forced"]["candidate_mean_nll"] = 1.25
            write(fixture.numerical, numerical)
            code, result = m19.qualify(fixture.args())
            self.assertEqual(code, 1)
            self.assertIn("category_mean_nll_delta", result["failed_gates"])
