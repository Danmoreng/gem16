...
)
{
    ...
    auto argmin_cost = [&]()
    {
        ...
        // Only lane 0 holds the complete strict-compare warp reduction. The
        // pinned upstream source has every lane write these four shared
        // locations, which is a data race and was reported by Compute
        // Sanitizer racecheck. Preserve the reduction order while making the
        // shared-memory publication defined.
        if (lane_id == 0)
        {
