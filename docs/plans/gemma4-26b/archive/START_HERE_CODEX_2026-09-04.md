> Historical task-routing snapshot at `8d057db`; current instructions are in [START_HERE_CODEX.md](../START_HERE_CODEX.md).
> Relative links were relocated; historical facts and decisions are preserved.
