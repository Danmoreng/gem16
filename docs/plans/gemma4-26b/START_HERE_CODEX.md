...
current three-run row reaches 6,570.312 mean prompt tok/s and 142.843 mean ordinary-decode tok/s on 16K+64, passing
...
`artifacts/m20/optimization-decode-no-contribution-write.json`.
