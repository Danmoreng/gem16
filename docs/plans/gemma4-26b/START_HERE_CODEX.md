...
two-row-tile promotions reaches 5,050.92 prompt tok/s and 139.106 ordinary-decode tok/s on 16K+64 with the accepted
output hash. This remains a development characterization; M20 still owns the formal 3-warm-up/10-retained-run result.
See `artifacts/m20/optimization-grouped-two-row-tiles.json`.
