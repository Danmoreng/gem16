...
two-row-tile promotions, CTA-wide grouped-expert activation staging, asynchronous K64 double buffering, exact
eight-token router weight reuse and prepared global K/V staging reaches 5,595.83 prompt tok/s and 138.826
...
`artifacts/m20/optimization-prepared-global-kv.json`.
