...
two-row-tile promotions and CTA-wide grouped-expert activation staging reaches 5,358.33 prompt tok/s and 138.863
...
`artifacts/m20/optimization-grouped-shared-activation-tile.json`.
