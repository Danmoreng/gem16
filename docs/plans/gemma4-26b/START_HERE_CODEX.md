...
current three-run row reaches 6,594.831 mean prompt tok/s and 142.250 mean ordinary-decode tok/s on 16K+64, passing
...
`artifacts/m20/optimization-decode-router-top8.json`.
