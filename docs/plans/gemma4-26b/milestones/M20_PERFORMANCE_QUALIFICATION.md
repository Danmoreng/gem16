...
Status: in progress; current adjacent 16K+64 candidate averages 6,570.312 prompt and 142.843 ordinary-decode tok/s; fixed owner decode target and formal 3/10 telemetry run remain
...
The current 6,570.312/142.843 development row passes the prompt target and non-blocking stretch but remains an
