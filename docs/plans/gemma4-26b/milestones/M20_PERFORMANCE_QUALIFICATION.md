...
Status: in progress; current adjacent 16K+64 candidate averages 6,586.402 prompt and 140.459 ordinary-decode tok/s; fixed owner decode target and formal 3/10 telemetry run remain
...
The current 6,586.402/140.459 development row passes the prompt target and non-blocking stretch but remains an
