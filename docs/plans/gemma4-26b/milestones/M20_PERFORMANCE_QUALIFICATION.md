...
Status: in progress; current adjacent 16K+64 candidate averages 6,594.831 prompt and 142.250 ordinary-decode tok/s; fixed owner decode target and formal 3/10 telemetry run remain
...
The current 6,594.831/142.250 development row passes the prompt target and non-blocking stretch but remains an
