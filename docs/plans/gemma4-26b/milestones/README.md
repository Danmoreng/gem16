...
M13 passed with `proceed`, and M14–M17 are accepted. M22 product behavior and a bounded prefill decision precede
the clean candidate freeze; M21 long-context and M20 performance then qualify that exact candidate. The owner
