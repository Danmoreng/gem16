> Historical snapshot at `8d057db`. Current policy is [ACTIVE_DECISIONS.md](../ACTIVE_DECISIONS.md).
> Link paths were adjusted for this archive location; the recorded decisions are unchanged.
...
[`archive/ACTIVE_DECISIONS_2026-08-28_GEMMA4_26B_FAST_TRACK.md`](ACTIVE_DECISIONS_2026-08-28_GEMMA4_26B_FAST_TRACK.md).
